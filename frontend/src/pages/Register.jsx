...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 selection:bg-black/10 dark:selection:bg-white/20 pt-16 transition-colors duration-300">
            <div className="w-full max-w-md bg-white border border-gray-200 dark:bg-white/[0.02] dark:border-white/10 rounded-2xl p-8 backdrop-blur-xl shadow-xl dark:shadow-2xl transition-all duration-300">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight transition-colors duration-300">Create an account</h2>
                    <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm transition-colors duration-300">Join NexMeet to start collaborating</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5 transition-colors duration-300">Full Name</label>
                        <input
                ...
                <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">
                    ...
                    <Link to="/login" className="text-black dark:text-white hover:underline font-medium">Sign in</Link>
                </p>
            </div>
        </div>
    );
